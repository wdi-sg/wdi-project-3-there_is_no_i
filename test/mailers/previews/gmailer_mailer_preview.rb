...
class GmailerMailerPreview < ActionMailer::Preview
  ...
  def send_reservation_update_preview
    GmailerMailer.send_reservation_update(Reservation.last, Reservation.last.email, 'Reservation updated')
  end

  def send_reservation_delete_preview
    GmailerMailer.send_reservation_delete(Reservation.last, Reservation.last.email, 'Reservation deleted')
  end
