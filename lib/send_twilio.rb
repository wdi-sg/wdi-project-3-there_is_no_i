module SendTwilio
  ...
  def sms_send_back_queue(walkin)
    if walkin.phone != nil and walkin.phone != ''
      message = "Dear #{walkin.name}, your table at #{walkin.restaurant.name} has been reassigned. We will notify you again when the next available table is ready. In the meantime, you may start placing your orders at https://locavorusrex.herokuapp.com/restaurants/#{walkin.restaurant.id}/menu_items"
  ...
  def sms_requeue(walkin)
    if walkin.phone != nil and walkin.phone != ''
      message = "Dear #{walkin.name}, you have been re-queued at #{walkin.restaurant.name}. Your queue number is #{walkin.queue_number}. We will notify you again when your table is ready. In the meantime, you may start placing your orders at https://locavorusrex.herokuapp.com/restaurants/#{walkin.restaurant.id}/menu_items"
